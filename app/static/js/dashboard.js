// API URL is loaded from shared.js
// Production: https://flowdesk-saas.up.railway.app/api
...
async function loadSummary() {
  ...
  document.getElementById("stat-month").textContent = fmt(data.month_revenue);
